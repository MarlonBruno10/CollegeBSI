...
public class ArvoreBinariaBusca<T> implements IArvoreBinaria {
    ...
    @Override
    public void remover(No no) throws NoInexistenteException, ArvoreVaziaException {
    ...
    @Override
    public No buscar(int dado) throws NoInexistenteException, ArvoreVaziaException {
    ...
    @Override
    public No visitar(No no) throws NoInexistenteException, ArvoreVaziaException {
    ...
    @Override
    public void preOrdem(No raiz) throws ArvoreVaziaException {
        if (estaVazia()) {
            throw new ArvoreVaziaException();
        }
        if (raiz != null) {
    ...
    @Override
    public void inOrdem(No raiz) throws ArvoreVaziaException {
        if (estaVazia()) {
            throw new ArvoreVaziaException();
        }
        if (raiz != null) {
    ...
    @Override
    public void posOrdem(No raiz) throws ArvoreVaziaException {
        if (estaVazia()) {
            throw new ArvoreVaziaException();
        }
        if (raiz != null) {
    ...
    public void percorrerEmLargura(No raiz) throws ArvoreVaziaException {
